...
import com.exemplo.ponto.client.AuthServiceClient;
import com.exemplo.ponto.model.Funcionario;
import com.exemplo.ponto.model.RegistroPonto;
import com.exemplo.ponto.repository.AdministradorRepository;
import com.exemplo.ponto.repository.FuncionarioRepository;
import com.exemplo.ponto.repository.RegistroPontoRepository;
...
public class AdministradorController {
    ...
    public AdministradorController(AdministradorRepository adminRepo, 
    ...
    public Funcionario criarFuncionario(@Valid @RequestBody Funcionario funcionario,
        ...
        try {
            ...
            Funcionario salvo = funcionarioRepo.save(funcionario);
    ...
    public List<Funcionario> listarFuncionarios(@RequestHeader("X-User-Role") String userRole) {
        validarAdmin(userRole);
